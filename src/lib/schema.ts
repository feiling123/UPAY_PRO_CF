...
async function ensureDefaultAdmin(env: Env): Promise<void> {
  await env.DB.prepare(
    `INSERT OR IGNORE INTO users (username, password_hash, role, created_at_ms, updated_at_ms)
...
const DEFAULT_ADMIN_PASSWORD_HASH = "pbkdf2-sha256$120000$CBZNeU3Y1LbqU2qw-fcu_Q$fShrFiJJQfzklQLc9GS0J3VRGqgPWOPrxwRxGHkvDoc";
